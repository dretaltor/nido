// Fuente: Instituto Geográfico Nacional / Registro Nacional CR
// División Territorial Administrativa 2024 — 7 provincias, 84 cantones, ~490 distritos
export interface Canton { nombre: string; distritos: string[] }
export interface Provincia { nombre: string; cantones: Canton[] }

export const COSTA_RICA: Provincia[] = [
  { nombre: 'San José', cantones: [
  ...
  { nombre: 'Cartago', cantones: [
    { nombre: 'Cartago', distritos: ['Oriental','Occidental','Carmen','San Nicolás','Aguacaliente o San Francisco','Guadalupe o Arenilla','Corralillo','Tierra Blanca','Dulce Nombre','Llano Grande','Quebradilla'] },
    { nombre: 'Paraíso', distritos: ['Paraíso','Santiago','Orosi','Cachí','Llanos de Santa Lucía','Birrisito'] },
    { nombre: 'La Unión', distritos: ['Tres Ríos','San Diego','San Juan','San Rafael','Concepción','Dulce Nombre','San Ramón','Río Azul'] },
    { nombre: 'Jiménez', distritos: ['Juan Viñas','Tucurrique','Pejibaye','La Victoria'] },
  ...
  { nombre: 'Heredia', cantones: [
    { nombre: 'Heredia', distritos: ['Heredia','Mercedes','San Francisco','Ulloa','Varablanca'] },
    { nombre: 'Barva', distritos: ['Barva','San Pedro','San Pablo','San Roque','Santa Lucía','San José de la Montaña','Puente Salas'] },
  ...
  { nombre: 'Guanacaste', cantones: [
    ...
    { nombre: 'Tilarán', distritos: ['Tilarán','Quebrada Grande','Tronadora','Santa Rosa','Líbano','Tierras Morenas','Arenal','Cabeceras'] },
  ...
  { nombre: 'Limón', cantones: [
    ...
    { nombre: 'Guácimo', distritos: ['Guácimo','Mercedes','Pocora','Río Jiménez'] },
  ]},
]
