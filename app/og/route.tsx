  ...
  return new ImageResponse(
    (
      <div style={{ width:'100%', height:'100%', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'#0D1F15', position:'relative' }}>
        ...
        <div style={{ position:'absolute', inset:0, background:'radial-gradient(ellipse at 70% 50%, rgba(200,169,110,0.1) 0%, transparent 60%)' }}/>
        ...
        {/* Tagline */}
        <div style={{ fontSize:28, color:'rgba(255,255,255,0.7)', fontFamily:'Georgia,serif', fontStyle:'italic', marginBottom:40, textAlign:'center' }}>
          Propiedades en Costa Rica con IA
        </div>

        {/* Stats */}
        <div style={{ display:'flex', gap:48, marginBottom:40 }}>
          {[['412+','Propiedades'],['2.4×','Más cierres'],['24/7','Valeria IA']].map(([val,label]) => (
