        ...
        <div style={{maxWidth:1400,margin:'0 auto'}}>
          ...
          <div className="precios-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:16,maxWidth:900,margin:'0 auto'}}>
            {[
              ...
              { plan:'Black', precio:'$99', periodo:'/mes', desc:'Para asesores top · 7 días gratis por lanzamiento', features:['Propiedades ilimitadas','Valeria IA con memoria','CRM con score de leads','Leads premium de calculadoras','Valeria por WhatsApp — mentora + alertas en vivo','Asesoría legal y notarial con el equipo legal de NIDO','Tour 360° (1 por mes, adicionales con costo)','Soporte en 2 horas','Panel propietario'], cta:'Empezar Black gratis 7 días', href:'/registro?plan=enterprise', featured:false },
            ].map((p,i) => (
