...
const PLANES = [
  ...
  },
  {
    ...
    features: [
      ...
      { texto: 'Asesoría legal y notarial con el equipo legal de NIDO', ok: true },
...
const DIFERENCIAS = [
  ...
  { feature: 'Asesoría legal y notarial', gratis: '—', pro: '—', enterprise: 'Con el equipo legal de NIDO' },
